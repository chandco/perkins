							...
							<?php foreach( $posts as $attachment ) { 
								...
								<?php } ?>
									<div class="gllr_image_block">
										<p style="width:<?php echo $gllr_options['gllr_custom_size_px'][1][0]+20; ?>px;height:<?php echo $gllr_options['gllr_custom_size_px'][1][1]+20; ?>px;" id="gal" style="display:none;">
											<a rel="gallery_fancybox" href="<?php echo $image_attributes_large[0]; ?>" title="<?php echo get_post_meta( $attachment->ID, $key, true ); ?>" onclick="return false;" class="isrc">
...
$('#gallery').before('').cycle({ 
    ...
    //speed:  'fast', 
    timeout: 3000, 
    //pager:  '.gllr_image_block',
	pager:  '#isrc', 
     
    // callback fn that creates a thumbnail to use as pager anchor 
    pagerAnchorBuilder: function(idx, slide) { 
        return '<img src="' + slide.src + '" width="160" height="120" />'; 
    } 
});
</script>
-->
...
$(document).ready(function(){
	$(".isrc").click(function(){
		thiImage = $(this).attr("href");
		//alert($(this).attr("href"));
		$(".gallery-image").attr("src",thiImage);
		return false;
	});
});
	(function($){
