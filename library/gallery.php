...
function perkin_add_extra_image_sizes() {


	
	add_image_size( 'blog-thumbnail-crop', 600, 400, array( 'center', 'center' ) );
	add_image_size( 'blog-thumbnail', 400 );
	add_image_size( 'featured-image', 1620 );
	add_image_size( 'mobile-large', 600 );
	add_image_size( 'tablet-large', 900 );
}

add_action( 'after_setup_theme', 'perkin_add_extra_image_sizes' );
